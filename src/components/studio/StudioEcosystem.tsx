...
export default function StudioEcosystem() {
  ...
  return (
    <section
      id="ecosystem"
      className="relative pt-[clamp(72px,10vw,120px)] pb-[clamp(72px,10vw,120px)] px-[clamp(16px,4vw,72px)] overflow-hidden"
    >
      <div className="relative max-w-[1600px] mx-auto">
            ...
            <div className="grid grid-cols-12 gap-6 items-end">
              <div className="col-span-12 md:col-span-8">
                <h2 className="font-display text-[clamp(36px,5.5vw,76px)] uppercase leading-[0.95] tracking-[-0.025em] text-wd-text">
                  Companies on our <span className="text-wd-gold">radar</span>.
                </h2>
              </div>
        ...
        {/* Add your company */}
        <Reveal delay={0.08}>
          <div className="mt-16 pt-10 border-t border-wd-gold/25">
            {addSubmitted ? (
              <div className="py-6">
                <h4 className="font-display text-[clamp(26px,3.5vw,40px)] uppercase leading-[0.95] tracking-[-0.02em] text-wd-text mb-3">
              ...
              >
                <div className="flex items-start justify-between mb-2 gap-4">
                  <h4 className="font-display text-[clamp(22px,3vw,32px)] uppercase leading-[0.95] tracking-[-0.02em] text-wd-text">
                    Add Your Company
                  </h4>
                  <button
                    type="button"

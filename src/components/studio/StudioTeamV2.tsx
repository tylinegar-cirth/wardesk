  ...
  return (
    ...
    >
      ...
      <div className="p-5 md:p-6 border-t border-wd-gold/25">
        ...
        {member.essaySlug && (
          <Link
            href={`/studio/essays/${member.essaySlug}`}
            className="font-mono text-[10px] tracking-[0.18em] uppercase text-wd-gold hover:text-wd-text transition-colors duration-300 inline-flex items-center gap-2"
          >

...
export default function ArticleModal({ onClose }: { onClose: () => void }) {
  ...
  return createPortal(
    <div
      onClick={onClose}
      className={`fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-black/70 backdrop-blur-[32px] transition-opacity duration-300 ${
    ...
    >
      <div
        ...
        className={`w-full max-w-[680px] max-h-[90vh] bg-wd-surface border border-wd-border rounded-[20px] overflow-auto shadow-[0_32px_80px_rgba(0,0,0,0.6)] transition-all duration-[450ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] ${
          visible
